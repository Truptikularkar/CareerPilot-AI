...
class CandidateParser:
    ...
    def parse_all(cls) -> CandidateProfile:
        ...
        skills = [
            ...
            Skill(name="Machine Learning", category=SkillCategory.MACHINE_LEARNING, evidence_level="PROFESSIONAL", evidence_status="VERIFIED", proficiency_level="Proficient", years_of_experience=1.5),
            Skill(name="Generative AI & LLMs", category=SkillCategory.GENAI, evidence_level="PROFESSIONAL", evidence_status="VERIFIED", proficiency_level="Advanced", years_of_experience=1.5),
            Skill(name="ETL / ELT Pipelines", category=SkillCategory.DATA_ENGINEERING, evidence_level="PROFESSIONAL", evidence_status="VERIFIED", proficiency_level="Advanced", years_of_experience=1.9),
            Skill(name="BigQuery ML", category=SkillCategory.MACHINE_LEARNING, evidence_level="PROFESSIONAL", evidence_status="VERIFIED", proficiency_level="Proficient", years_of_experience=1.5),
            ...
            Skill(name="LangChain", category=SkillCategory.GENAI, evidence_level="PERSONAL_PROJECT", evidence_status="VERIFIED", proficiency_level="Proficient", years_of_experience=1.0),
        ...
        profile = CandidateProfile(
            ...
            phone="+91 9834055766",
            location=location,
            linkedin_url="https://www.linkedin.com/in/trupti-kularkar-579062210/",
            github_url="https://github.com/Truptikularkar",
